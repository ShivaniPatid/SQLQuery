...
-------- CURSOR--------
-- A cursor in SQL Server is a database object that allows us to retrieve each row at a time and manipulate 
-- its data. A cursor is nothing more than a pointer to a row. It's always used in conjunction with a SELECT 
-- statement.
